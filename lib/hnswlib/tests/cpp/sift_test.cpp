/*
    benchmarking and validation test that uses the famous SIFT dataset 
    to evaluate the HNSW algorithm's performance on a real-world, high-dimensional dataset
*/
