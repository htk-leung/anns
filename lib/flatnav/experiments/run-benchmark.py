...
def main(
    ...
    # EDIT : added to differentiate between flatnav and flatnav with hnsw base
    if index_type == "flatnav" and use_hnsw_base_layer:
        experiment_key = f"{dataset_name}_{index_type}_hnsw_base"
...
def run_experiment():
    ...
    ROOT_DIR = "/home/hl5737/anns-research-hnsw/code/w11/results/data" #"/root"
    ...
    metrics_file_path = os.path.join(ROOT_DIR, "venvmetrics", args.metrics_file)
